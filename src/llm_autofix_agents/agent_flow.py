...
from llm_autofix_agents.flow.run_orchestrator import RunOrchestrator
...
_BASELINE_INSTRUCTIONS = (
    ...
    "Your goal is to diagnose failing tests or error logs, inspect the repository, apply a minimal and maintainable fix, "
    ...
    "Before reporting done, inspect the repository diff and validate with tests when a test command or test runner is available. "
