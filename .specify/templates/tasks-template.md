...
- [ ] T004 Define experiment artifact schema (attempt log, diff, verdict, metadata)
- [ ] T005 Define failure-signal schema adapters (tests, logs, bug report)
...
- [ ] T006 Setup isolation mechanism (container or equivalent) and document runtime metadata
- [ ] T007 [P] Implement repository state reset strategy between attempts
- [ ] T008 [P] Implement command execution guardrails and whitelist policy
- [ ] T009 Configure structured logging and artifact persistence
- [ ] T010 Setup environment configuration management
- [ ] T011 Define evidence oracle integration (test gate + fallback gate for bug-report flows)
- [ ] T012 Define max-attempt, timeout, and termination reason handling
- [ ] T013 Define replication protocol for stochastic runs (N replications, aggregation policy)
...
- [ ] T022 [US1] Persist per-attempt artifact bundle for this story flow
...
- [ ] TXXX Aggregate experiment metrics and generate comparative report tables
- [ ] TXXX Document threats to validity and reproducibility limits
- [ ] TXXX Compute run-to-run variance metrics and confidence intervals
